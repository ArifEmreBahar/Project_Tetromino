...
public class KeyboardInput : IPlayerInput
{
    ...
    {
        {KeyCode.RightArrow, PlayerAction.MoveLeft},
        {KeyCode.LeftArrow, PlayerAction.MoveRight},
        {KeyCode.UpArrow, PlayerAction.MoveDown},
        {KeyCode.DownArrow, PlayerAction.Rotate},
